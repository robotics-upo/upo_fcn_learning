...
class Capture {
	...
	public:
		...
		Capture(sensor_msgs::PointCloud* obs, vector<upo_msgs::PersonPoseUPO>* people, geometry_msgs::PoseStamped* goal, vector<geometry_msgs::PoseStamped>* agent);
		Capture();
		~Capture();

		void setup();

		void setScenario(sensor_msgs::PointCloud* obs, vector<upo_msgs::PersonPoseUPO>* people, geometry_msgs::PoseStamped* goal, vector<geometry_msgs::PoseStamped>* agent);
		...
		void generateImg(sensor_msgs::PointCloud* obs, vector<upo_msgs::PersonPoseUPO>* people, geometry_msgs::PoseStamped* goal, vector<geometry_msgs::PoseStamped>* agent, string name);
		void generateImg(string name);
